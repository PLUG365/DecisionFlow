...
- Code Apps のステージ Badge は `ds_decision` 作成成功後に楽観更新し、500ms 間隔・最大 3 秒の短時間ポーリングで Power Automate 整合結果を確認
