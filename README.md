...
3. Power Platform 管理センターで `DecisionFlow-Deciders` グループチームを作成・関連付けし、`ds_Decider` ロールを割り当てる
4. 利用者に `ds_Applicant`、管理者に `ds_Admin` を割り当てる
5. Code Apps のアプリを開き、申請作成・提出・判断キュー表示が動くことを確認する
6. Copilot Studio を使う場合は、認証、Dataverse ナレッジ、Teams チャネル公開を環境に合わせて確認する
